...
public class LocalizacaoBethaDba
{
    ...
    public string nro_termo { get; set; }
    public string dt_prazo { get; set; }
    public string i_manutencao { get; set; }
    public string novo_cod3 { get; set; }
    public string cod_anterior3 { get; set; }
